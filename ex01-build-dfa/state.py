...
class State:
    ...
    def setClasses(self, classes): # sets the alphabet classes, which is a map of sets
    ...
    def onClassGoTo(self, onClass): # returns the particular transition on the class
